...
export class PaymentComponent implements OnInit {
  ...
  constructor(private apiService: ApiService,  private httpStatus: HTTPStatus, private snackBar: MatSnackBar) {
  }
  ...
  submit() {
    ...
    if (this.payment.paymentMode != null && this.payment.paymentMode === 'Card') {
    ...
    this.apiService.processPayment(payment)
      .subscribe( res => {
        ...
        //  this.reset();
          ...
          this.snackBar.open('ErroCode:' + res.body.failureCode + 'and Error message :' + res.body.failureMessage, '', {
            duration: 10000,
          });
        }
